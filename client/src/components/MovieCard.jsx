...
const MovieCard = ({movie}) => {
  ...
  return (
    <div className="flex flex-col justify-between p-3 backdrop-blur bg-black/70 md:bg-white/10 md:border border-gray-300/20 rounded-2xl hover:-translate-y-1 transition duration-300 w-66">
